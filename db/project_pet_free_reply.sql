...
--
-- Table structure for table `pet_free_reply`
--

DROP TABLE IF EXISTS `pet_free_reply`;
...
--
-- Dumping data for table `pet_free_reply`
--

LOCK TABLES `pet_free_reply` WRITE;
/*!40000 ALTER TABLE `pet_free_reply` DISABLE KEYS */;
INSERT INTO `pet_free_reply` VALUES (6,1,'ekswl','1234','미니핀',NULL,NULL);
